#!/usr/bin/env python3
"""Run ATAC (protein) IB-VAE training for CITE-seq seed 1."""
import sys
...
cfg = TrainConfig(
    modality='atac',
    processed_path=str(PROCESSED_DIR / 'citeseq_pbmc_atac.h5ad'),
...
result = train(cfg)
print(f"ATAC done, best_val={result['best_val']:.6f}", flush=True)
